        ...
        <>
            ...
            >
                    ...
                    {menuItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                onClick={() => setIsOpen(false)}
                                className={`flex items-center gap-3 px-3 py-2.5 rounded-md transition-all font-medium text-sm group select-none cursor-pointer ${isActive
                ...
                <div className="p-4 border-t border-gray-100">
                    <button className="flex items-center gap-3 px-3 py-2.5 rounded-md w-full text-left text-sm font-medium text-red-600 hover:bg-red-50 transition-colors">

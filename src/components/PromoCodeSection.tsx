...
export default function PromoCodeSection({
    ...
    return (
        <div className="pt-2 border-t border-gray-100">
            ...
            {appliedPromo ? (
                <div className="bg-green-50 border border-green-300 rounded-md p-2.5 flex items-center justify-between">
                    <div>
                        <span className="text-xs font-bold text-green-800 font-mono">{appliedPromo.code}</span>
                        <span className="text-[11px] text-green-600 font-semibold ml-2">({appliedPromo.discountPercent}% OFF Applied)</span>
                    </div>
                </div>
            ) : (

    ...
    return (
        <footer className="bg-[#f8fafc] text-gray-700 font-sans border-t border-gray-200 mt-auto">
            ...
            <div className="border-b border-gray-200 bg-[#f1f5f9] py-2.5 sm:py-4 px-4">
                <div className="max-w-[1400px] mx-auto grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 text-center sm:text-left">
            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 py-6 lg:py-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 sm:gap-8 lg:gap-10 text-center sm:text-left">
                    ...
                    <div className="space-y-3 flex flex-col items-center sm:items-start">
                        <h3 className="text-gray-900 text-[16px] font-bold tracking-normal">Categories</h3>
                        <ul className="space-y-1.5 text-xs sm:text-sm text-gray-600 flex flex-col items-center sm:items-start">
                            <li>
                    ...
                    {/* Quick Navigation */}
                    <div className="space-y-3 flex flex-col items-center sm:items-start">
                        <h3 className="text-gray-900 text-[16px] font-bold tracking-normal">Quick Links</h3>
                        <ul className="space-y-1.5 text-xs sm:text-sm text-gray-600 flex flex-col items-center sm:items-start">
                            <li>
                    ...
                    <div className="space-y-1.5 flex flex-col items-center sm:items-start">
                        <h3 className="text-gray-900 text-[16px] font-bold tracking-normal">Support</h3>
                        <div className="space-y-1.5 text-xs sm:text-sm text-gray-600 flex flex-col items-center sm:items-start text-center sm:text-left">
                            ...
                            <div className="flex items-start justify-center sm:justify-start gap-2">
                                ...
                                <span className="max-w-[185px] sm:max-w-[230px] text-center sm:text-left leading-relaxed">121, Varni Plaza, Mota Varachha, Surat, Gujarat, India - 394101</span>
                            </div>
                        </div>

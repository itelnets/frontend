...
export const metadata: Metadata = {
    title: 'Privacy Policy | Itelents',
    description: 'Comprehensive Privacy Policy detailing how Itelents collects, protects, uses, and shares your personal data.',
};
            ...
            <div className="bg-white rounded-none sm:rounded-lg shadow-sm border border-[#458500]/20 flex flex-col flex-1 min-h-0 overflow-hidden">
                <div className="p-3 sm:p-5 border-b-2 border-[#458500]/20 flex items-center justify-between shrink-0">
                    <div className="flex items-center gap-2">
                        ...
                        <h1 className="text-[16px] sm:text-[18px] font-bold text-gray-800 m-0">Itelents - Privacy Policy</h1>
                    </div>
                </div>
                <div className="px-4 sm:px-6 lg:px-8 py-4 flex-1 min-h-0 overflow-y-auto">
                    <div className="prose !text-[14px] sm:!text-[15px] text-gray-700 max-w-none space-y-3 sm:space-y-4">
                        ...
                        <ul className="list-disc pl-5 space-y-1">
                            ...
                            <li>
                                <strong>Legal &amp; Regulatory Authorities:</strong> Government agencies or law enforcement officials when required by law, subpoena, court order, or to defend the legal rights, safety, and property of Itelents and its users.
                            </li>
                        </ul>

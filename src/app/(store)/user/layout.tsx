...
export default function UserLayout({
    ...
    const allLinks = [
        ...
        { name: 'Cart', href: '/cart', icon: 'M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 100 4 2 2 0 000-4z' },
        { name: 'Messages', target: '_blank', href: 'https://wa.me/9558688770', icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z' },
        { name: 'Terms and Conditions', href: '/user/terms-and-conditions', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
        { name: 'Privacy and Policy', href: '/user/privacy-policy', icon: 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z' },
    ];
    ...
    return (
        <div className="flex-1 font-sans">
            <div className="max-w-[1400px] mx-auto px-0 sm:px-4 py-0 sm:py-4 md:py-6">
                <div className="flex flex-col md:flex-row gap-0 sm:gap-4 lg:gap-8">

                    {/* Sidebar Navigation */}
                    <div className={`w-full md:w-[250px] lg:w-[280px] xl:w-[300px] shrink-0 h-fit bg-white border border-[#458500]/20 sm:border-solid sm:rounded-lg sm:shadow-sm overflow-hidden ${!isMenuPage ? 'hidden md:block' : ''}`}>

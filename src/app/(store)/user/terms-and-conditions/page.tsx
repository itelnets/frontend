...
export const metadata: Metadata = {
    title: 'Terms and Conditions | Itelents',
    description: 'Terms and conditions for using Itelents platform and services.',
};
            ...
            <div className="bg-white rounded-none sm:rounded-lg shadow-sm border border-[#458500]/20 flex flex-col flex-1 min-h-0 overflow-hidden">
                ...
                <div className="px-4 sm:px-6 lg:px-8 py-4 flex-1 min-h-0 overflow-y-auto">
                    <div className="prose !text-[14px] sm:!text-[15px] text-gray-700 max-w-none space-y-3 sm:space-y-4">
                        ...
                        <p>
                            Welcome to the Itelents family of websites, mobile websites, and mobile apps (collectively, the “Site”). This Itelents Terms of Use Agreement ("Agreement") sets forth the agreement between Itelents (“Itelents”, “we”, or “us”), and each user ("user", "your" or "you"). This Agreement governs your use of the Site and the Itelents Privacy Policy (“Privacy Policy”). Please read this Agreement carefully and fully before using the Site or disclosing to us any personal information.
                        </p>
                        <p>
                        ...
                        <p>
                            Itelents’ Code of Conduct is included in this Agreement. Customers, vendors, visitors to the Site, and stakeholders are expected to comply with the Code of Conduct.
                        </p>
                        ...
                        <p>
                            It is your responsibility to ascertain and comply with all applicable local, state, federal, and international laws regarding the receipt, possession, use, and sale of any item purchased from this Site. When ordering from Itelents, you are responsible for assuring the product can be lawfully imported into your country. Customers are the importers of record and must comply with all laws and regulations of the destination country.
                        </p>
                        <p>
                            Itelents reserves the right to prohibit purchases of any merchandise to resellers. Resellers are defined as a company or an individual that purchases goods with the intention of selling them rather than using them.
                        </p>
                        ...
                        <p>
                            With respect to items sold by Itelents, we cannot confirm the price of an item until you order. Despite our best efforts, a small number of the items in our catalog may be mispriced. Subject to applicable law, if the correct price of an item sold by Itelents is higher than our stated price, we will, at our discretion, either contact you for instructions before shipping or cancel your order and notify you of such cancellation.
                        </p>
                        ...
                        <p>
                            User Generated Content Guidelines are included in this Agreement. All User Generated Content must comply with the guidelines which are a binding part of this Agreement. User Generated Content, including product reviews, solely reflect the views and opinions expressed by the contributor and not those of Itelents. Itelents does not verify or endorse any claims made in reviews.
                        </p>

                        <h2 className="text-[16px] sm:text-lg lg:text-xl font-bold text-gray-900 mt-5 sm:mt-6 !mb-1 sm:!mb-2">13. Privacy</h2>
                        <p>
                            By agreeing and adhering to the terms of this Agreement, you also confirm that you understand Itelents’s Privacy Policy. To learn more about what we do with your information please review the Privacy Policy.
                        </p>
                        ...
                        <p>
                            You agree that the use of the Site is at your sole risk. The Site and the materials contained therein are provided on an "as is" and "as available" basis, except as otherwise expressly provided for in this Agreement. Itelents and its respective officers, directors, employees, affiliates and other representatives, successors and assigns of any of them (collectively, "Itelents Entities") expressly disclaim all warranties of any kind, whether express or implied, including, but not limited to the implied warranties of merchantability, fitness for a particular purpose and non-infringement.
                        </p>
                        <p>
                            Itelents Entities make no warranty that the Site will meet your requirements, the Site will be timely, secure, error free or uninterrupted, the results obtained from the Site will be accurate or reliable, the quality of any products, services, information or other material obtained by you through the Site will meet your expectations and any Site errors will be corrected. Itelents does not represent or warrant that materials in the Site are accurate, complete, reliable, current, or error-free.
                        </p>
                        <p>
                            To the maximum extent permitted by applicable law, in no event shall Itelents Entities be liable for any indirect, incidental, special or consequential damages (including damages for loss of business, loss of profits, loss of good will, loss of use, loss of data, cost of procuring substitute goods, services or information, litigation or the like), whether based on breach of contract, breach of warranty, tort (including negligence), product liability or otherwise, even if Itelents Entities are advised of the possibility of such damages.
                        </p>
                        ...
                        <p className="text-sm sm:text-base">
                            ...
                            <a href="mailto:itelnets3@gmail.com" className="text-[#458500] hover:text-[#366800] hover:underline font-bold break-all">
                                itelnets3@gmail.com
                            </a>
                        </p>
                    </div>
